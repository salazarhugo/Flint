...
namespace Photon.Pun.Demo.PunBasics
{
	...
	public class CameraWork : MonoBehaviour
	{
		...
		{
			cameraTransform = GetComponent<Camera>().transform;//Camera.main.transform;
			isFollowing = true;
			cameraTransform.position = new Vector3(head.transform.position.x, head.transform.position.y, head.transform.position.z + 0.2f);
